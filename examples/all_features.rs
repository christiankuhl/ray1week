...
fn main() {
    ...
    let ground = Rc::new(Lambertian::new(Colour::new(0.48, 0.83, 0.53)));
    ...
    let light = Rc::new(DiffuseLight::from_colour(7.0 * Colour::WHITE));
    world.add(Quad::new(
    ...
    let sphere_material = Rc::new(Lambertian::new(Colour::new(0.7, 0.3, 0.1)));
    ...
    let boundary = Sphere::new(Point3::ZERO, 5000.0, Rc::new(Dielectric::new(1.5)));
    world.add(ConstantMedium::isotropic(
        Rc::new(boundary),
        0.0001,
        Colour::WHITE,
    ...
    let pertext = Rc::new(NoiseTexture::plain(0.2));
    world.add(Sphere::new(
    ...
    let white = Rc::new(Lambertian::new(0.73 * Colour::WHITE));
    let ns = 1000;
    for _ in 0..ns {
    ...
    world.add(Translate::new(
        Rc::new(Rotate::new(Rc::new(boxes2), 0.0, 15.0, 0.0)),
    ...
    let renderer = cam.renderer(250, 50);
    let mut file = File::create("all_features.ppm").unwrap();
